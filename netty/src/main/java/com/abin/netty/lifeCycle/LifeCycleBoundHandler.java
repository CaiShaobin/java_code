package com.abin.netty.lifeCycle;
 ...
 */
public class LifeCycleBoundHandler extends ChannelInboundHandlerAdapter {
    static Logger logger;
    static {
        logger = LoggerFactory.getLogger(LifeCycleBoundHandler.class);
    }
